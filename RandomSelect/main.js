$(document).ready(function(){
    $("input").click(function()
    {
        ...
        $(".content h2").text(singer[randomChildNumber]);
        $(".content h2").attr("style","display");
        $(".content h2").attr("style","font-weight:bold");
        $(".content h3").text(content[randomChildNumber]);
        $(".content h3").attr("style","display");
